...
b;for(b in a)c+="&"+b+"="+a[b];return c};f.prototype.getJsonResult=function(a,c){jQuery.ajax(a,{success:function(a){c(a)},dataType:"json"})};f.prototype.parseFlickrImageURL=function(a){var c=jQuery(a).attr("data-original")||jQuery(a).attr("data-lazy-src")||jQuery(a).attr("src"),b=c.split("/"),d=b[2].split(".").slice(0,1)[0].replace("farm",""),f=b[3],e=b[4].split("_"),h=e.slice(0,1)[0],g=e.slice(1,2)[0],g=e.slice(1,2)[0],e=e.slice(2,3),e=e.length?e.length&&e[0].split(".").slice(0,1)[0]:"",b=b.slice(-1)[0].split(".").slice(-1)[0];
return{node:a,url_string:c,farm_id:d,server_id:f,id:h,secret:g,size:e,file_ext:b}};f.prototype.getAllFlickrImageObjects=function(a){"undefined"===typeof a&&(a="img");a=jQuery(a).filter(function(){var a=jQuery(this).attr("src"),b=jQuery(this).attr("data-original"),c=jQuery(this).attr("data-lazy-src");return a&&a.match(/static.?flickr.com/)||b&&b.match(/static.?flickr.com/)||c&&c.match(/static.?flickr.com/)});for(var c=[],b=0,d=a.length;b<d;b++)c.push(this.parseFlickrImageURL(a[b]));return c};f.prototype.getExif=
function(a,c){var b=this.appendURLParams({method:"flickr.photos.getExif",photo_id:a});this.getJsonResult(b,c)};f.prototype.getRecentURL=function(a){var c=this.appendURLParams({method:"flickr.photos.getRecent"});this.getJsonResult(c,a)};d.Base=f})(com||(com={}));
