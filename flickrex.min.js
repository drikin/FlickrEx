...
file_ext:a}};e.prototype.getAllFlickrImageObjects=function(){for(var c=jQuery("img").filter(function(){var a=$(this).attr("src");return a&&a.match(/staticflickr.com/)}),b=[],a=0,d=c.length;a<d;a++)b.push(this.parseFlickrImageURL(c[a]));return b};e.prototype.getExif=function(c,b){var a=this.appendURLParams({method:"flickr.photos.getExif",photo_id:c});this.getJsonResult(a,b)};e.prototype.getRecentURL=function(c){var b=this.appendURLParams({method:"flickr.photos.getRecent"});this.getJsonResult(b,c)};
d.Base=e})(com||(com={}));